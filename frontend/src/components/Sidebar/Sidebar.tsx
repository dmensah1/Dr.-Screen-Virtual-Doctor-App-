            ...
            <nav className="mt-10">
              ...
              <div
                ...
                onClick={() => {
                  setDashboard(false);
                  setSecondTab(true);
                  const where: string = userDetails.isDoctor ? '/patients' : '/booking'
                  history.push(where);
                }}
              >
              ...
              <p className="flex items-center mt-5 py-2 px-8 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="none"
